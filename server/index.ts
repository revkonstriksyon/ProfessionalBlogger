...
(async () => {
  ...
  // Use environment port or fallback to port 5000
  // This ensures compatibility with Replit's port forwarding
  ...
  server.listen({
    ...
    log(`Local URL: http://0.0.0.0:${port}`);
